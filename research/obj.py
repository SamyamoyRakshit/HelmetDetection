...
from object_detection.utils import visualization_utils as vis_util
from samya_util.utils import encodeImageIntoBase64
...
class MultiClassObj:
    def __init__(self, imagePath, modelPath):
        ...
        self.class_names_mapping = {
            1: "Helmets" # 1: "motorcycle", 2: "with_helmet", 3: "without_helmet"
        }
    ...
    def getPrediction(self):
        ...
        opencodebase64 = encodeImageIntoBase64("output.jpg")
        # json_image = dict(zip(ing_dict, image_64_encode_list))
        ...
        # # Clean up
        # cv2.destroyAllWindows()
        listOfOutput.append({"image": opencodebase64('en_US.UTF-8')})
        return listOfOutput
